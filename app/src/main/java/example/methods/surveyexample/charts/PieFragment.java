...
public class PieFragment extends Fragment {
    ...
    private void setupPieChart() {
        ...
        pieChart.setCenterText("Current Result");
    ...
    private void loadPieChartData() {
        ...
        entries.add(new PieEntry(Float.parseFloat(String.valueOf(yes)), "Yes"));
        entries.add(new PieEntry(Float.parseFloat(String.valueOf(no)), "No"));
